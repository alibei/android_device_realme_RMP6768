...
LOCAL_MULTILIB := both
LOCAL_SRC_FILES_arm := v30/arm64/arch-arm-armv8-a/shared/vndk-core/libmedia_helper.so
LOCAL_SRC_FILES_arm64 := v30/arm64/arch-arm64-armv8-a/shared/vndk-core/libmedia_helper.so
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_TARGET_ARCH := arm arm64
LOCAL_MODULE_TAGS := optional
